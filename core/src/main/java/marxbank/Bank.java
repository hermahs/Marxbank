...
/**
 * Bank is on the top of the object hierarchy in the application. Only one bank instance can exist
 * at one time, and the singleton pattern (Thread safe with double checked locking) is used to
 * achieve this.
 */
