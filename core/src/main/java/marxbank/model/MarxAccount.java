...
public class MarxAccount extends Account {
   ...
   * case, creates a new transaction instance from this to the account with the lowest registered
   * balance to get rid of the excess amount. If such an account cannot be found, the balance will
   * be kept.
   */
  @Override
