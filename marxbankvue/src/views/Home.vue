<template class="text-gray-600 body-font">
  <div class=" min-w-[60%]">
    ...
    <main class="text-on-same-line space-x-36">
      ...
      <div class="relative w-full h-48 bg-cover bg-center group rounded-lg overflow-hidden shadow-lg transition duration-300 ease-in-out"
        ...
        <div class="absolute inset-0 bg-green-500 bg-opacity-75 transition duration-300 ease-in-out"></div>
      ...
      <div class="w-full">
        <RecentTransaction :date="transaction.date" 
