package marxbank.marxbankfx.util;
...
public class TextFieldFormatter {
   ...
   * 
   * @return if the change matches the criterea of the number formatter, return change, else return
   *         null
   */
   ...
   * 
   * @return if the change matches the criterea of the decimal formatter, return change, else return
   *         null
   */
